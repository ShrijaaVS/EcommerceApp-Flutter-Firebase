// import 'package:ecommerceapp/login/phone_login_implementation/login_event.dart';
// import 'package:ecommerceapp/login/phone_login_implementation/login_state.dart';
// import 'package:flutter_bloc/flutter_bloc.dart';
// import 'package:bloc/bloc.dart';
// import 'package:firebase_auth/firebase_auth.dart';
//
// class PhoneLoginBloc extends Bloc<PhoneLoginEvent, PhoneLoginState> {
//   PhoneLoginBloc() : super(LoginInitial()) {
//     on<PhoneLoginEvent>((event, emit) async {
//       if (event is PhoneLoginPressed) {
//         emit(LoginLoading());
//         try {
...
//
//           emit(OtpAutoVerified());
//         },
//         verificationFailed: (FirebaseAuthException e) {
//           emit(ErrorState(error: e.message.toString()));
//         },
//         codeSent: (String verificationId, int? resendToken) {
//           emit(OtpCodeSent(verificationId: verificationId));
//         },
//         codeAutoRetrievalTimeout: (String verificationId) {
//           emit(OtpAutoRetrievalTimeout(verificationId: verificationId));
//         },
//       );
//     } catch (e) {
...
import 'package:bloc/bloc.dart';
import 'package:ecommerceapp/repositories/login/phone_auth_repository.dart';
  ...
  FutureOr<void> _onSendOtp(
    ...
    try {
      await phoneAuthRepository.verifyPhone(
        ...
        codeAutoRetrievalTimeout: (String verificationId) {
          add(OnPhoneAuthErrorEvent(error: verificationId));
        },
      );
    } catch (e) {
